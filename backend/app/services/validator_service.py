...
class ValidatorService:
    async def validate_lead(
        ...
        Returns (is_valid, response_body, request_payload).
        """
        ...
        try:
            ...
            if response.status_code != 200:
                ...
                return False, {"error": f"API returned {response.status_code}", "body": result}, params
